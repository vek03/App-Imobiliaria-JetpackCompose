...
import com.example.appmobiliaria.components.DarkButton
...
fun NovoComprarScreen(navController: NavController){
    Column(modifier = Modifier
        ...
        //CASA
        DarkButton(text = "Casa", icon = Icons.Default.KeyboardArrowRight){
            navController.navigate("home")
        }
        ...
        //APARTAMENTO
        DarkButton(text = "Apartamentos", icon = Icons.Default.KeyboardArrowRight){
            navController.navigate("home")
        }
        ...
        //CHACARA
        DarkButton(text = "Chácaras", icon = Icons.Default.KeyboardArrowRight){
            navController.navigate("home")
        }
